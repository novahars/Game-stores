...
export default function ProductGrid({ currentUser }) {
  ...
  useEffect(() => {
    if (selectedCategoryId) {
      ...
      setFilteredProducts(products); // Menampilkan semua produk jika tidak ada kategori yang dipilih
    }
  }, [selectedCategoryId, products]);

  const handlePurchase = (product) => {
    // Logika untuk menangani pembelian produk
            ...
            >
              <div className="relative">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = "/placeholder.jpg"; // Placeholder jika gambar gagal dimuat
                  }}
                />
